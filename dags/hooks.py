...
def transfer_function(ds, **kwargs):
    ...
    # source hook
    source_hook = PostgresHook(postgres_conn_id = 'postgres_conn_airflow', schema = 'airflow')
    source_conn = source_hook.get_conn()

    # destination hook
    destination_hook = PostgresHook(postgres_conn_id = 'postgres_conn_airflow', schema = 'airflow')
